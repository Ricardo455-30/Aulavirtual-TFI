...
import { crearExamen, listarExamenes } from "../controllers/examenes.controller.js";
...
// POST /api/examenes -> docente crea examen
router.post(
  "/",
  verifyToken,
  soloAdmin,
...
// GET /api/examenes/:id_asignacion -> listar exámenes
router.get(
  "/:id_asignacion",
  verifyToken,
  soloAdmin,
